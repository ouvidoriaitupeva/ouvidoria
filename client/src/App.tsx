...
function Router() { return <WouterRouter base={APP_BASE}><Switch><Route path="/" component={Home} /><Route path="/registro" component={RegistroPage} /><Route path="/sic" component={SicPage} /><Route path="/ouvidoria" component={OuvidoriaPage} /><Route path="/configuracoes" component={ConfiguracoesPage} /><Route path="/carta-servicos" component={CartaServicosPage} /><Route path="/relatorios" component={ReportsPage} /><Route path="/relatorios/" component={ReportsPage} /><Route path="/ouvidoria/relatorios" component={ReportsPage} /><Route path="/ouvidoria/relatorios/" component={ReportsPage} /><Route component={NotFoundPage} /></Switch></WouterRouter>; }
